...
console.log();
console.log(` Creating a new Yew material app in ${chalk.green(rootFolder)}. `);
console.log();

// This uses --no-tags and --depth 1 in order to make the cloning faster
run("git", ["clone", "--no-tags", "--depth", "1", "https://github.com/alibaba-inc/create-yew-material-app.git", gitFolder]);

// Copies the yew-material-app folder
cpr(path.join(gitFolder, "crates/yew-material-app"), folderName, {}, function (err, files) {
